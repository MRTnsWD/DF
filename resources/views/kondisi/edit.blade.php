                            ...
                            <form role="form" class="form-group mx-10 my-6"
                                ...
                                <div class="mb-3">
                                    <input type="text" id="Jenis_lantai" name="Jenis_lantai" class="form-control"
                                        ...
                                        value="{{ $kondisi->Jenis_lantai }}">
                                </div>

                                <label for="Jenis_dinding">Jenis Dinding</label>
                                <div class="mb-3">
                                    <input type="text" id="Jenis_dinding" name="Jenis_dinding"
                                        class="form-control" placeholder="Jenis_dinding"
                                        aria-label="Jenis_dinding"value="{{ $kondisi->Jenis_dinding }}">
                                </div>

                                <label for="Fasilitas_BAB">Fasilitas BAB</label>
                                <div class="mb-3">
                                    <input type="text" id="Fasilitas_BAB" name="Fasilitas_BAB"
                                        class="form-control" placeholder="Fasilitas_BAB"
                                        aria-label="Fasilitas_BAB"value="{{ $kondisi->Fasilitas_BAB }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    <input type="text" id="Penerangan" name="Penerangan" class="form-control"
                                        ...
                                        aria-label="Penerangan"value="{{ $kondisi->Penerangan }}">
                                </div>

                                <label for="Air_minum">Air_minum</label>
                                <div class="mb-3">
                                    <input type="text" id="Air_minum" name="Air_minum" class="form-control"
                                        placeholder="Air_minum"
                                        aria-label="Air_minum"value="{{ $kondisi->Air_minum }}">
                                </div>
