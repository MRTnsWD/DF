...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('rw.penduduk.index') }}">
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('rw.kondisi.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Kondisi Rumah</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kondisi Rumah</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Kondisi Rumah</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h6>Tambah Data Kondisi Rumah</h6>
                            <a href="{{ route('rw.kondisi.index') }}" class="btn btn-primary">Kembali</a>
                        </div>

                        <div class="card-body px-0 pt-0 pb-2">
                            <form role="form" enctype="multipart/form-data" class="form-group mx-10 my-6"
                                action="{{ route('rw.kondisi.store') }}" method="POST">
                                @csrf
                                <label for="jk">Penduduk</label>
                                <div class="mb-3">
                                    <select id="id_penduduk" name="id_penduduk" class="form-control"
                                        aria-label="id_penduduk">
                                        <option readonly value="">Pilih Penduduk</option>
                                ...
                                <div class="mb-3">
                                    <input type="number" id="Luas_lantai" name="Luas_lantai" class="form-control"
                                        placeholder="Luas_lantai" aria-label="Luas_lantai">
                                </div>

                                <label for="Jenis_lantai">Jenis Lantai</label>
                                <div class="mb-3">
                                    <input type="text" id="Jenis_lantai" name="Jenis_lantai" class="form-control"
                                        placeholder="Jenis_lantai" aria-label="Jenis_lantai">
                                </div>

                                <label for="Jenis_dinding">Jenis Dinding</label>
                                <div class="mb-3">
                                    <input type="text" id="Jenis_dinding" name="Jenis_dinding"
                                        class="form-control" placeholder="Jenis_dinding" aria-label="Jenis_dinding">
                                </div>

                                <label for="Fasilitas_BAB">Fasilitas BAB</label>
                                <div class="mb-3">
                                    <input type="text" id="Fasilitas_BAB" name="Fasilitas_BAB"
                                        class="form-control" placeholder="Fasilitas_BAB" aria-label="Fasilitas_BAB">
                                </div>

                                <label for="Penerangan">Penerangan</label>
                                <div class="mb-3">
                                    <input type="text" id="Penerangan" name="Penerangan" class="form-control"
